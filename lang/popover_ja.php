...
(
    ...
    'data_type'                => 'インポートするデータの種類を選択します。',
    'file_type'                => 'インポートするファイルのフォーマットを選択します。',
    'data_file'                => 'インポートするファイルを選択します。',
    'custom_lists'             => 'カスタムバリューデータをインポートする場合はインポート先のカスタムリストを選択します。',
    'key_column'               => 'ポストデータをインポートする場合はインポート先のポストタイプを選択します。',
    ...
    'use_advanced_cache_flg'  => 'スマートキャッシュよりさらに高速なスマートキャッシュ・アドバンスを使用できます。',
		'use_group_flg'           => '設定したグループ（組織・団体）ごとに独立した環境を利用できます。複数のグループがシステムを同時利用する際に有効です。',
		'advance_option'          => 'この機能はアドバンスライセンス以上で利用可能です。',
    'business_option'         => 'この機能はビジネスライセンスで利用可能です。',
);