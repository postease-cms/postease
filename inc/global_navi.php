...
<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-header">
		...
		<?php else:?>
		<a class="navbar-brand" href="./?view_page=index&amp;change=1&amp;clear=1">PostEase</a>
		<?php endif?>
	</div>
	<div class="collapse navbar-collapse target">
		<ul class="nav navbar-nav">
			...
			<li <?=($key==$_SESSION[$session_key]['common']['this_site'])?'class="active"':''?>><a href="./?view_page=index&this_site=<?=$key?>&amp;change=1&amp;reset_posttype=1"><?=$value?></a></li>
			<?php endforeach?>
			<?php endif?>
		</ul>
